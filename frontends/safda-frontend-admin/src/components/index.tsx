...
const estadoDoc: Record<EstadoDocumento, string> = {
  BORRADOR: 'bg-slate-100 text-slate-600', BORRADOR_APROBADO: 'bg-teal-100 text-teal-700', PENDIENTE_SUBIDA: 'bg-amber-100 text-amber-700',
...
const estadoDocLabel: Record<EstadoDocumento, string> = {
  BORRADOR: 'Borrador', BORRADOR_APROBADO: 'Borr. Aprobado', PENDIENTE_SUBIDA: 'Pend. subida', PDF_SUBIDO: 'PDF subido', EN_FLUJO: 'En flujo',
}
